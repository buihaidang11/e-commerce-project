        ...
        <div class="page-content">
            <div class="page-header">
                <div class="container-fluid">
                    <h4 class="my-4">Add Product</h4>
                    <div class="d-flex justify-content-center">
                        <form action="{{ url('add_product') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="pt-2">
                                <label class="text-bold text-white" style="width: 150px;">Product Title</label>
                                <input style="width: 300px; height: 40px" type="text" name="title" required>
                            </div>
                            <div class="pt-2 d-flex align-items-center">
                                <label class="text-bold text-white align-center me-1"
                                    style="width: 150px;">Description</label>
                                <textarea style="width: 400px; height: 80px; margin-left: 4px" type="text" name="description" required> </textarea>
                            </div>
                            <div class="pt-2">
                                <label class="text-bold text-white" style="width: 150px;">Price</label>
                                <input style="width: 200px; height: 40px;" type="text" name="price" required>
                            </div>
                            <div class="pt-2">
                                <label class="text-bold text-white" style="width: 150px;">Quantity</label>
                                <input style="width: 150px; height: 40px" type="number" name="quantity" required>
                            </div>
                            <div class="pt-2">
                            ...
                            <div class="pt-2">
                                <label class="text-bold text-white" style="width: 150px;">Product Image</label>
